...
package com.devapps.droids.ui.photosphere;
...
public class Sphere {
    ...
    public Sphere(final Context context, final int depth, final float radius) {
        ...
        mTextureDataHandle0 = TextureHelper.loadTexture(context, R.drawable.hps);
    ...
    protected String getVertexShader(Context context) {
        return RawResourceReader.readTextFileFromRawResource(context, R.raw._vertex_shader);
    }

    protected String getFragmentShader(Context context) {
        return RawResourceReader.readTextFileFromRawResource(context, R.raw._fragment_shader);
    }
