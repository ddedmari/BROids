...
/**
 * An activity which allows to stream the Camera Feeds from the Android device and stream it to any remote device. We use the Wowza Streaming Engine for handling the communication between the remote android device and the client device.
 * 
 * Created by mahendraliya on 26/04/15.
 */
public class LiveFeedActivity extends Activity implements 
OnClickListener, 
RtspClient.Callback, 
Session.Callback, 
...
OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(LiveFeedActivity.this);
